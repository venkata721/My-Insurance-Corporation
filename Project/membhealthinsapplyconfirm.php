...
<html>
	...
	<head>
		<meta charset = "utf-8">
		<title> Health Insurance Page Confirmation</title>
	...
	<body>
				...
				<header class="top">
					...
					<a href="memberpage.php" ><img src="images/backward.ico" height="40px" width="50px" style="position: absolute;"></a>
				...
				<center><h1> Your Application is Successful & We will get back to discuss about more benefits !!!!!  </h1></center>
				<center><img height="490px" width="1175px" src="images/tyou.jpg" style=" border: 3px solid white;"> </center>
