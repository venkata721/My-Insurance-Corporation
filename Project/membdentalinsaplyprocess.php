...
if(((	empty($age) || empty($weight) || empty($Hgt) || empty($_POST['usres'])	|| 	empty($_POST['gender']) || empty($_POST['plan']) || 
		empty($_POST['prevdent']) || empty($_POST['addtnben']) || empty($_POST['guiltdrvng']) || empty($_POST['motviol']) || 
		empty($_POST['drlsuspnd']) || empty($_POST['tobusg']) || empty($_POST['hisbp']) || empty($_POST['hishd']) || empty($_POST['parhd'])))
		&& isset($_POST["apply"]))
	{
			echo "<script> alert('Please make sure to enter all the fields') </script>";
			header("refresh:1; url=membdentalinsaply.php"); 
...
{
$plntype = "Not Avaialble";
}
if(isset($_POST['prevdent']))
{
 $prevdental = $_POST['prevdent'];
}
else
{
$prevdental = "Not Avaialble";
}
if(isset($_POST['addtnben']))
{
$addldent = $_POST['addtnben'];
}
else
{
$addldent = "Not Avaialble";
}
...
?>
	...
	<body>
				...
				<header class="top">
					...
					<a href="membdentalinsaply.php" ><img src="images/backward.ico"  height="40px" width="50px" style=" position: absolute; right: 350px;"></a>
				...
				<div style="overflow: auto;">			
				       <h2 style="text-align: center;background-color: skyblue">Details For Applied Dental Insurance Product </h2>
				<form method="post" action="insertDentProduct.php">
				...
				<fieldset name="productname" value="DENTAL INSURANCE" style=" float:left; font-size: 20px; text-align: center; height: 30px; width: 560px; background-color: skyblue"><b> DENTAL INSURANCE </b></fieldset>
				<input type="hidden" name="productname" value="DENTAL INSURANCE">

				<fieldset style="float:left; font-size: 20px; text-align: left; height: 580px; width: 1180px; background-color: white;">
				...
				<fieldset style="float:left;  height: 1200px; width: 1180px; background-color: white;">
				<br/>
				...
				<br/>
				<fieldset style="float: left;font-size: 20px; text-align: left;height: 20px; width:580px ; border: none; background-color: lightyellow;">
				Have you had previous dental insurance within the past 60 days ? 
				</fieldset>
				<fieldset style="font-size: 20px; text-align: left;height: 20px; width:585px ;border: none; background-color: lightyellow;">
				<?php echo $prevdental; ?> 
				</fieldset>
				...
				<br/>
				<fieldset style="float: left;font-size: 20px; text-align: left;height: 55px; width:580px ; border: none; background-color: lightyellow;">
				...
				<fieldset style="font-size: 20px; text-align: left;height: 55px; width:585px ;border: none; background-color: lightyellow;">
				<?php echo $parthd; ?> 
				</fieldset>
				<br/>
